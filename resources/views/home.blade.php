...
<section class="container--slider">
    ...
    <div class="slider" id="slider">
        ...
        <img src="../resources/img/slider/img1.webp" alt="">
        </div>

        <div class="slider--section">
        <img src="../resources/img/slider/img2.webp" alt="">
        </div>

        <div class="slider--section">
        <img src="../resources/img/slider/img3.webp" alt="">
        </div>
    </div>
                        ...
                        <div class="box--ow-max product--card" id="1">
                            ...
                            <div class="product--info">
                                ...
                                <p id="product--description" class="p--description" >
                                   {{ $specLaptop->ram_gb }}
                                   {{ $specLaptop->ram_tipo }},
                                   {{ $specLaptop->discod_gb }}
                                   {{ $specLaptop->discod_tipo }},
                                   {{ $specLaptop->procesador_marca }}
                                   {{ $specLaptop->procesador_modelo }} Gen
                                   {{ $specLaptop->procesador_gen }}, 
