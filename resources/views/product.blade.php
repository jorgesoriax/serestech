     ...
     <header>
        ...
        <div id="header--nav--buttons" class="nav--buttons">
            ...
            href="https://www.facebook.com/SeresTech21/" >
                <img src="../resources/img/social-media/fb-rounded-w.svg" 
            ...
            <a href="https://wa.me/528110649320/?text=Hola realizando prueba" target="_blank" rel="noopener noreferrer">
...
<!-- **
    ...
    <section id="product--info">
        ...
        <div id="container--dets">
            ...
            <a href="https://api.whatsapp.com/send?phone=+8123626323&text=Hola" target="_blank" rel="noopener noreferrer">
...
<!-- **
    ...
    <main id="product--specs">
        ...
        <!--
            Se require función php para generar un layout dinámico
            al momento de cargar la base de datos, que asigne uno de dos
            estilos diferentes para casilla en cada iteración
        -->
