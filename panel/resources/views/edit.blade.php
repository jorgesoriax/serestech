...
<form action="{{ route('panel.update', $specLaptop) }}" method="POST" enctype="multipart/form-data">
    ...
    <table border="0" style="background: gainsboro">
        ...
        <tr>
            <td>Estética</td><td><input type="text" placeholder="Numérico" name="status_aesthetics" value="{{ $specLaptop->product->status_aesthetics }}">Del 1 al 10</td>
        </tr>
        <tr>
    ...
    <table border="0" style="background: gainsboro">
        ...
        <tr>
            <td>Imagen 1</td><td><img src="{{ asset($specLaptop->product->image->image_1) }}"></td>
            <td><input type="file" name="image_1"></td>
        </tr>
        <tr>
            <td>Imagen 2</td><td><img src="{{ asset($specLaptop->product->image->image_2) }}"></td>
            <td><input type="file" name="image_2"></td>
        </tr>
        <tr>
            <td>Imagen 3</td><td><img src="{{ asset($specLaptop->product->image->image_3) }}"></td>
            <td><input type="file" name="image_3"></td>
        </tr>
        <tr>
            <td>Imagen 4</td><td><img src="{{ asset($specLaptop->product->image->image_4) }}"></td>
            <td><input type="file" name="image_4"></td>
        </tr>
        <tr>
            <td>Imagen 5</td><td><img src="{{ asset($specLaptop->product->image->image_5) }}"></td>
            <td><input type="file" name="image_5"></td>
        </tr>
        <tr>
            <td>Imagen 6</td><td><img src="{{ asset($specLaptop->product->image->image_6) }}"></td>
            <td><input type="file" name="image_6"></td>
        </tr>
        <tr>
            <td>Imagen 7</td><td><img src="{{ asset($specLaptop->product->image->image_7) }}"></td>
