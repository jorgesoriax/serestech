...
@section('content')
    ...
    <table border="0" style="background: gainsboro">
        ...
        <tr>
            <td>image_1: </td><td><img src="{{ asset($specLaptop->product->image->image_1) }}"></td>
        </tr>
        <tr>
            <td>image_2: </td><td><img src="{{ asset($specLaptop->product->image->image_2) }}"></td>
        </tr>
        <tr>
            <td>image_3: </td><td><img src="{{ asset($specLaptop->product->image->image_3) }}"></td>
        </tr>
        <tr>
            <td>image_4: </td><td><img src="{{ asset($specLaptop->product->image->image_4) }}"></td>
        </tr>
        <tr>
            <td>image_5: </td><td><img src="{{ asset($specLaptop->product->image->image_5) }}"></td>
        </tr>
        <tr>
            <td>image_6: </td><td><img src="{{ asset($specLaptop->product->image->image_6) }}"></td>
        </tr>
        <tr>
            <td>image_7: </td><td><img src="{{ asset($specLaptop->product->image->image_7) }}"></td>
        </tr>
        <tr>
